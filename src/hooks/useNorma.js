...
import { getOcupacoes, getGrupos, getCargaMap, getNormaInfo, buscarCNAE, getCNAEsDivisao, temCNAECadastrado, getAV, getTRRF, getExtintores, getIluminacao, getSinalizacao, getBrigada } from '../data/normas/index'
