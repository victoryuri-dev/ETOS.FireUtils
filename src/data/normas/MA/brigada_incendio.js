...
// parsing). Serve só de FALLBACK offline/dev — a fonte de verdade é a base
// normativa central (normas_dados no Supabase, ver
// supabase/migrations/*seed_normas_brigada* e src/lib/normasRemote.js),
// consumida por getBrigada() em normas/index.js, mesmo padrão de
// getExtintores/getHidrantes/etc.
//
...
export const TABELA_A1 = [
  ...
  { divisoes: ['H-2'], grupoLabel: 'H – Serviço de saúde e institucional', descricao: 'Locais onde pessoas requerem cuidados especiais por limitações físicas ou mentais', risco: 'medio', isento: false, faixas: [2, 4, 5, 6, 8], regraAcima10: 'nota5', nivelTreinamento: 'nota8', nivelInstalacao: 'nota8', notas: [5, 8] },
  { divisoes: ['H-3'], grupoLabel: 'H – Serviço de saúde e institucional', descricao: 'Hospital e assemelhado', risco: 'baixo', isento: false, faixas: [2, 3, 4, 5, 6], regraAcima10: 'nota5', nivelTreinamento: 'basico', nivelInstalacao: 'basico', notas: [5] },
  { divisoes: ['H-4'], grupoLabel: 'H – Serviço de saúde e institucional', descricao: 'Repartição pública, edificações das forças armadas e policiais', risco: 'medio', isento: false, faixas: [2, 3, 4, 5, 6], regraAcima10: 'nota5', nivelTreinamento: 'basico', nivelInstalacao: 'basico', notas: [5] },
  { divisoes: ['H-5'], grupoLabel: 'H – Serviço de saúde e institucional', descricao: 'Local onde a liberdade das pessoas sofre restrições', risco: 'baixo', isento: false, faixas: [2, 3, 4, 5, 6], regraAcima10: 'nota5', nivelTreinamento: 'basico', nivelInstalacao: 'basico', notas: [5] },
  { divisoes: ['H-6'], grupoLabel: 'H – Serviço de saúde e institucional', descricao: 'Clínica e consultório médico e odontológico', risco: 'medio', isento: false, faixas: [2, 3, 4, 5, 6], regraAcima10: 'nota5', nivelTreinamento: 'nota8', nivelInstalacao: 'nota8', notas: [5, 8] },
