-- Adiciona a placa E1 (Telefone para uso em caso de incêndio — NBR 13434-3)
-- ao catálogo de sinalização, que faltava desde a seed original (ver
-- 20260906120005_seed_normas_sinalizacao_ma.sql) — pictograma cadastrado
-- localmente em src/data/normas/MA/sinalizacao.js, aqui só o texto
-- normativo (o `img` nunca vai pra base central — ver
-- normas/index.js.anexarImagens).
